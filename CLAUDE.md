...
PromptBlocks is an **AI model benchmarking repository**. Each subdirectory (`GLM-5/`, `codex-5.3/`, `gemini-3/`, `GLM-5.1/`, `gemini-3.1/`, `kimi-k2.5/`, `kimi-k2.6/`, `minimax-2.5/`) contains a complete, independent implementation of the same PromptBlocks application generated by different AI models. The goal is to compare how well different AIs implement the requirements in `prompt.md`.
...
├── GLM-5.1/           # Implementation from GLM-5.1 model
├── codex-5.3/         # Implementation from Codex 5.3 model
├── gemini-3/          # Implementation from Gemini 3 model
├── gemini-3.1/        # Implementation from Gemini 3.1 model
├── kimi-k2.5/         # Implementation from Kimi K2.5 model
├── kimi-k2.6/         # Implementation from Kimi K2.6 model
└── minimax-2.5/       # Implementation from MiniMax 2.5 model
```
...
cd GLM-5  # or any other implementation directory
...
npm run test:watch  # (availability varies by implementation)
